...
/**
 * This represents an Interval type living on Integer. Objects of this class are immutable. Proudly
 * lend from amidarsim.
 *
...
public final class Interval {
    ...
    /**
     * Creates a new interval in the bounds l,u inclusive with l &lt;= u. The bounds given are
     * switched if u &lt; l.
     *
    ...
    /**
     * Returns TRUE iff there is no place k such that k is contained in this interval or in the given
     * interval I.
     *
    ...
    /**
     * Returns a string representation of this interval of the form "[l:u]".
     */
    ...
    public boolean equals(Object i) {
        if (this == i) {
            System.out.println("You are comparing an identical interval");
            return true;
        }
    ...
    /**
     * This comparator delivers Intervals in ascending order to their lower bound. That is leftmost
     * outermost order.
     */
    ...
    /**
     * This comparator delivers Intervals in ascending order to their upper bound. That is rightmost
     * innermost order.
     */
    public static class UBComp implements Comparator<Interval> {
        public int compare(Interval a, Interval b) {
            if (a.ubound.equals(b.ubound)) return b.lbound.compareTo(a.lbound);
